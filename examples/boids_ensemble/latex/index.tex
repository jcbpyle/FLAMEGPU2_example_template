...
\begin{DoxyCode}{0}
\DoxyCodeLine{population1 = experiment\_generator.AgentPopulation();}
\DoxyCodeLine{population1.setDefaultState('Default1');}
\DoxyCodeLine{population1.setPopSizeRandom((256,512));}

\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysubsection{Setting up a genetic algorithm}\label{index_autotoc_md4}
